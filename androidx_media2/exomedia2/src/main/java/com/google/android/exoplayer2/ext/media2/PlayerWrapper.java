...
public final class PlayerWrapper {
  ...
  private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PlayerWrapper.class);
  ...
  private final class ComponentListener implements Player.EventListener, AudioListener {
    ...
    public void onPlayWhenReadyChanged(boolean playWhenReady, int reason) {
      log.trace("onPlayWhenReadyChanged() " + playWhenReady + " reason: " + reason);
